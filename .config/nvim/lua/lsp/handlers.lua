...
M.on_attach = function(client, bufnr)
  ...
  -- vim.api.nvim_command('autocmd CursorHold <buffer> lua vim.lsp.diagnostic.show_line_diagnostics({ border = "rounded" })')
  vim.api.nvim_command('autocmd CursorHold <buffer> lua vim.diagnostic.open_float({ scope = "cursor" })')
